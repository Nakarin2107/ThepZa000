        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (currentUser) {
                ...
                // แสดงชื่อผู้ใช้ในส่วนต่างๆ ของหน้าเว็บ
                document.getElementById('userDisplay').textContent = user.displayName; // แสดงชื่อผู้ใช้บนปุ่มเมนูดรอปดาวน์
                document.getElementById('userDisplayName').textContent = user.displayName; // แสดงชื่อผู้ใช้ในเมนูดรอปดาวน์
            } else {
